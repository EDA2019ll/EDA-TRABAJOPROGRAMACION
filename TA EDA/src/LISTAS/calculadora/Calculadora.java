...
public class Calculadora extends javax.swing.JFrame {
    ...
    public Calculadora() {
        ...
        this.repaint();
        ImageIcon imagen = new ImageIcon(getClass().getResource("/imagenes/Azul.jpg"));
        Icon iconoFondo = new ImageIcon(imagen.getImage().getScaledInstance(fondo.getWidth(), fondo.getHeight(), Image.SCALE_DEFAULT));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 330, 38));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 47, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 47, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 47, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, 100, -1));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 250, 47, -1));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, 47, -1));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 310, 47, -1));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 340, 50, -1));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 250, 47, -1));
        ...
        getContentPane().add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 47, -1));
        ...
        getContentPane().add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 47, -1));
        ...
        getContentPane().add(BotonIgual, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 310, 50, 60));
        ...
        getContentPane().add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, 47, -1));
        ...
        getContentPane().add(jButton14, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, 47, -1));
        ...
        getContentPane().add(jButton15, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 310, 47, -1));
        ...
        getContentPane().add(jButton16, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 340, 47, -1));
        ...
        getContentPane().add(jButton17, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 250, 47, -1));
        ...
        getContentPane().add(jButton18, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 310, 47, -1));
        ...
        getContentPane().add(jButton19, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 340, 47, -1));
        ...
        getContentPane().add(jButton20, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 280, -1, -1));
        ...
        getContentPane().add(jButton21, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 280, 50, -1));

        botongraficadora.setBackground(new java.awt.Color(153, 0, 153));
        botongraficadora.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        botongraficadora.setForeground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(botongraficadora, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 100, 50));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 110, 38));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 150, 120, 38));
        ...
        getContentPane().add(jButton23, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 250, -1, -1));
